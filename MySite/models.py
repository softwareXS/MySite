...
class Entry(models.Model):
    ...
    abstract=models.TextField(max_length=256,null=True,blank=True,verbose_name='摘要载要')
    ...
    def get_absolute_url(self):
        return reverse('MySite:MySite_detail',kwargs={'MySite_id':self.id}) #http://127.0.0.1/MySite/3
